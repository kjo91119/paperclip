                ...
                <div className="space-y-5">
                  ...
                  <div className="group">
                    ...
                    <textarea
                      ...
                      placeholder="이 회사가 이루려는 목표를 적어보세요"
                      value={companyGoal}
              ...
              {step === 2 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">첫 에이전트를 만드세요</h3>
                      <p className="text-xs text-muted-foreground">
                        이 에이전트가 작업을 수행하는 방식을 고르세요.
                      </p>
                    </div>
                  </div>
                  <div>
              ...
              {step === 3 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">첫 작업을 주세요</h3>
                      <p className="text-xs text-muted-foreground">
                        너무 큰 일보다 작은 시작 작업이 좋습니다. 예: 버그 수정,
                        조사, 스크립트 작성.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="에이전트가 해야 할 일을 조금 더 자세히 적어보세요..."
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        이제 시작 작업을 만들고, 에이전트를 깨우고, 이슈를 엽니다.
                      </p>
                    </div>
                  </div>
