...
export function buildResponseLanguageNote(): string {
  return [
    ...
    "Sound closer to a direct ChatGPT or Claude answer than to a formal status memo.",
    ...
    "Keep comments concise. Prefer 1-3 short paragraphs or a few short bullets over long formal templates.",
    "Do not default to a management-report tone.",
    "Avoid report-style words like '검증 완료', 'owner', 'gate', '승인 플로우', or 'headcount' unless they are truly needed for the decision.",
    "If no action is needed, say that plainly in the board's language.",
